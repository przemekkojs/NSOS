...
from users.serializers import LecturerSerializer, StudentSerializer
...
class ScheduleItemSerializer(serializers.ModelSerializer):
    ...
    course_code = serializers.CharField(source='course_group.course.course_code', read_only=True)
